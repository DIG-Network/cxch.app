 ...
 * @returns {any}
 */
export function build_melt_spends(request) {
    const ret = wasm.build_melt_spends(request);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function build_wrap_spends(request) {
    const ret = wasm.build_wrap_spends(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function puzzle_hash_to_address(puzzle_hash, network) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.puzzle_hash_to_address(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function wxch_asset_id() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.wxch_asset_id();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function wxch_outer_puzzle_hash(inner_puzzle_hash) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(inner_puzzle_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wxch_outer_puzzle_hash(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wxch_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
