...
// Prominently displays the canonical wXCH CAT asset id. Clicking it copies the
// full asset id to the clipboard.
export function AssetId() {
  const assetId = wxch_asset_id();
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="text-xs uppercase tracking-wide text-gray-400">wXCH Asset ID</span>
